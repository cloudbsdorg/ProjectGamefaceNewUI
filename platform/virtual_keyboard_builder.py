...
from platform.interfaces import keyboard_interface

if sys.platform == 'darwin':
    from platform.darwin.darwin_virtual_keyboard import DarwinVirtualKeyboard
if sys.platform != 'darwin':
    from platform.generic.generic_virtual_keyboard import GenericVirtualKeyboard
if sys.platform == 'win32':
    from platform.windows.windows_virtual_keyboard import WindowsVirtualKeyboard
